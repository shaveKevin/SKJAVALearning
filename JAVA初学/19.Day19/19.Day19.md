...
编译后的结果为：
```
方法调用前交换前a的值为:10 交换前b的值为：30
交换前a的值为:10 交换前b的值为：30
交换后a的值为:30 交换后b的值为：10
方法调用后交换前a的值为:10 交换前b的值为：30
```
...
![12-130Q1221013F0](https://ws3.sinaimg.cn/large/006mQyr2ly1g4zswnoubzj30by060glk.jpg)
...
```
编译后的结果为：
输入java: this is a command line 200 -100
```
args[0]: this
args[1]: is
args[2]: a
